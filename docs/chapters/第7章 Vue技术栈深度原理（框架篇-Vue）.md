...
<details><summary>#### Proxy 陷阱与 Reflect 的配合</summary>
...
<details><summary>#### 为什么 Proxy 不能代理原始值</summary>
...
<details><summary>#### Vue 2 的响应式处理流程</summary>
...
<details><summary>#### Vue 2 中数据变化了但视图不更新</summary>
...
<details><summary>#### 依赖收集的完整流程</summary>
...
<details><summary>#### 为什么解构响应式对象会丢失响应性</summary>
...
<details><summary>#### 触发更新的完整流程</summary>
...
<details><summary>#### 修改属性后视图没有立即更新</summary>
...
<details><summary>#### 各陷阱的拦截对应关系</summary>
...
<details><summary>#### 为什么 ownKeys 要用特殊的 ITERATE_KEY</summary>
...
<details><summary>#### reactive 的创建流程</summary>
...
<details><summary>#### reactive 对象解构后丢失响应性</summary>
...
<details><summary>#### 为什么原始值不能用 Proxy 代理</summary>
...
<details><summary>#### 如何安全地替换 reactive 对象的全部数据</summary>
...
<details><summary>#### RefImpl 类的简化实现</summary>
...
<details><summary>#### ref 和 reactive 怎么选</summary>
...
<details><summary>#### 模板自动解包的实现</summary>
...
<details><summary>#### 忘记写 .value 导致的 bug</summary>
...
<details><summary>#### 自动解包的编译和运行时配合</summary>
...
<details><summary>#### 普通对象中的 ref 在模板中不解包怎么办</summary>
...
<details><summary>#### reactive 的 get/set 如何处理 ref 解包</summary>
...
<details><summary>#### 为什么数组中的 ref 不自动解包</summary>
...
<details><summary>#### readonly 的 Proxy handler</summary>
...
<details><summary>#### readonly 和 Object.freeze 的区别</summary>
...
<details><summary>#### shallowReactive 与 reactive 的 get 差异</summary>
...
<details><summary>#### 如何让 shallowReactive 的深层属性也触发更新</summary>
...
<details><summary>#### shallowRef 与 ref 的区别</summary>
...
<details><summary>#### 什么时候用 shallowRef 替代 ref</summary>
...
<details><summary>#### toRaw 的实现</summary>
...
<details><summary>#### toRaw 获取的对象修改会影响响应式对象吗</summary>
...
<details><summary>#### markRaw 的实现</summary>
...
<details><summary>#### markRaw 标记后还能恢复响应式吗</summary>
...
<details><summary>#### effect 的注册和执行流程</summary>
...
<details><summary>#### effect 栈为什么需要</summary>
...
<details><summary>#### track 的类型分类</summary>
...
<details><summary>#### 为什么有时候修改数据不触发更新</summary>
...
<details><summary>#### trigger 的操作类型与触发规则</summary>
...
<details><summary>#### 为什么同时修改多个属性只渲染一次</summary>
...
<details><summary>#### 清理策略的演进</summary>
...
<details><summary>#### 依赖不清理会有什么后果</summary>
...
<details><summary>#### Vue 中不同 effect 的 scheduler 实现</summary>
...
<details><summary>#### watch 的 flush 选项如何选择</summary>
...
<details><summary>#### lazy 在 effect 创建中的处理</summary>
...
<details><summary>#### lazy effect 如何手动触发</summary>
...
<details><summary>#### onTrack/onTrigger 的调用位置</summary>
...
<details><summary>#### 生产环境中 onTrack/onTrigger 会生效吗</summary>
...
<details><summary>#### 组件的自动 scope 管理</summary>
...
<details><summary>#### 不用 scope 会有什么问题</summary>
...
<details><summary>#### effectScope 的关键方法</summary>
...
<details><summary>#### onScopeDispose 和 onUnmounted 的区别</summary>
...
<details><summary>#### computed 的实现机制</summary>
...
<details><summary>#### computed 的 getter 中不要有副作用</summary>
...
<details><summary>#### dirty 标记的状态转换</summary>
...
<details><summary>#### computed 依赖没有变化但每次都重新计算</summary>
...
<details><summary>#### 可写 computed 的实现</summary>
...
<details><summary>#### setter 中不要直接修改 computed 自身</summary>
...
<details><summary>#### watch 内部对不同侦听源的处理</summary>
...
<details><summary>#### 直接侦听 reactive 的属性值为什么不生效</summary>
...
<details><summary>#### immediate 在 watch 内部的处理</summary>
...
<details><summary>#### immediate 和 watchEffect 怎么选</summary>
...
<details><summary>#### deep 的递归遍历实现</summary>
...
<details><summary>#### deep 对性能的影响</summary>
...
<details><summary>#### flush 对应的调度队列</summary>
...
<details><summary>#### 什么时候必须用 flush: 'post'</summary>
...
<details><summary>#### watchEffect 与 watch 的内部差异</summary>
...
<details><summary>#### watchEffect 的异步代码中依赖不被追踪</summary>
...
<details><summary>#### onCleanup 的执行时机</summary>
...
<details><summary>#### 不用 onCleanup 会导致什么问题</summary>
...
<details><summary>#### 底层实现的差异</summary>
...
<details><summary>#### 同一个需求用 watch 和 watchEffect 如何实现</summary>
...
<details><summary>#### toRef 的实现</summary>
...
<details><summary>#### toRef 和直接用 ref 有什么区别</summary>
...
<details><summary>#### 标记检测的实现</summary>
...
<details><summary>#### unref 在 composable 中的典型用法</summary>
...
<details><summary>#### 数组方法重写的机制</summary>
...
<details><summary>#### 为什么 push 需要暂停追踪</summary>
...
<details><summary>#### 集合类型的 handler 实现</summary>
...
<details><summary>#### Map/Set 中的 ref 不会自动解包</summary>
...
<details><summary>#### 异步更新队列的工作流程</summary>
...
<details><summary>#### nextTick 和 setTimeout 的区别</summary>
...
<details><summary>#### data 函数的处理流程</summary>
...
<details><summary>#### data 中不要使用箭头函数</summary>
...
<details><summary>#### methods 的绑定过程</summary>
...
<details><summary>#### methods 中不能使用箭头函数</summary>
...
<details><summary>#### computed 选项的初始化</summary>
...
<details><summary>#### computed 和 methods 怎么选</summary>
...
<details><summary>#### watch 选项的初始化</summary>
...
<details><summary>#### watch 一个数组的多种方式</summary>
...
<details><summary>#### 生命周期钩子的执行顺序</summary>
...
<details><summary>#### beforeCreate 和 created 在 Composition API 中的替代</summary>
...
<details><summary>#### props 的验证流程</summary>
...
<details><summary>#### 不要直接修改 props</summary>
...
<details><summary>#### emits 的处理机制</summary>
...
<details><summary>#### 不声明 emits 导致 click 事件触发两次</summary>
...
<details><summary>#### setup 的执行时机</summary>
...
<details><summary>#### setup 中不能使用 this</summary>
...
<details><summary>#### setup 在组件初始化中的位置</summary>
...
<details><summary>#### setup 和 Options API 混用时的执行顺序</summary>
...
<details><summary>#### 为什么 setup 中 this 是 undefined</summary>
...
<details><summary>#### 从 Options API 迁移到 setup 的 this 替换</summary>
...
<details><summary>#### 编译器的转换步骤</summary>
...
<details><summary>#### script setup 如何与普通 script 共存</summary>
...
<details><summary>#### 编译器如何收集顶层绑定</summary>
...
<details><summary>#### 哪些绑定不会暴露给模板</summary>
...
<details><summary>#### 编译器的组件识别逻辑</summary>
...
<details><summary>#### 动态组件和自动注册</summary>
...
<details><summary>#### 编译器宏的转换过程</summary>
...
<details><summary>#### 类型声明和运行时声明不能混用</summary>
...
<details><summary>#### withDefaults 的编译转换</summary>
...
<details><summary>#### Vue 3.5+ 的解构默认值替代方案</summary>
...
<details><summary>#### required 验证的执行过程</summary>
...
<details><summary>#### required 和 default 同时存在</summary>
...
<details><summary>#### 类型检查的实现</summary>
...
<details><summary>#### TypeScript 类型声明方式如何添加 validator</summary>
...
<details><summary>#### defineEmits 的编译转换</summary>
...
<details><summary>#### Vue 3.3 之前的类型声明语法</summary>
...
<details><summary>#### 类型安全的实现机制</summary>
...
<details><summary>#### 事件参数类型与父组件回调参数不匹配</summary>
...
<details><summary>#### defineExpose 的工作机制</summary>
...
<details><summary>#### TypeScript 中获取暴露内容的类型</summary>
...
<details><summary>#### defineOptions 的编译转换</summary>
...
<details><summary>#### defineOptions 不能设置哪些选项</summary>
...
<details><summary>#### defineSlots 的编译处理</summary>
...
<details><summary>#### defineSlots 和 useSlots 的关系</summary>
...
<details><summary>#### defineModel 的编译转换</summary>
...
<details><summary>#### defineModel 之前的传统写法对比</summary>
...
<details><summary>#### 修饰符的传递机制</summary>
...
<details><summary>#### Vue 3.4 之前如何处理自定义修饰符</summary>
...
<details><summary>#### 单向数据流的实现</summary>
...
<details><summary>#### 对象类型 prop 的"意外修改"</summary>
...
<details><summary>#### 静态和动态绑定的编译差异</summary>
...
<details><summary>#### 传递数字和布尔值时忘记加冒号</summary>
...
<details><summary>#### 验证流程的执行细节</summary>
...
<details><summary>#### 对象默认值不用工厂函数的后果</summary>
...
<details><summary>#### emit 的事件派发机制</summary>
...
<details><summary>#### 在模板中直接使用 $emit</summary>
...
<details><summary>#### 验证的执行机制</summary>
...
<details><summary>#### 运行时验证和类型声明能否同时使用</summary>
...
<details><summary>#### provide/inject 的查找链</summary>
...
<details><summary>#### 使用 Symbol 作为 key 避免命名冲突</summary>
...
<details><summary>#### 响应式 provide/inject 的数据流</summary>
...
<details><summary>#### 非响应式 provide 导致后代不更新</summary>
...
<details><summary>#### inject 默认值的处理逻辑</summary>
...
<details><summary>#### 忘记加第三个参数 true 导致工厂函数不执行</summary>
...
<details><summary>#### $attrs 的收集和透传</summary>
...
<details><summary>#### 多根元素时的透传警告</summary>
...
<details><summary>#### useAttrs 的实现</summary>
...
<details><summary>#### useAttrs 和 defineProps 的配合</summary>
...
<details><summary>#### v-bind="$attrs" 的编译和渲染</summary>
...
<details><summary>#### class 和 style 的合并行为</summary>
...
<details><summary>#### inheritAttrs 的工作机制</summary>
...
<details><summary>#### script setup 中如何设置 inheritAttrs</summary>
...
<details><summary>#### 模板引用的绑定时机</summary>
...
<details><summary>#### ref 在 onMounted 之前为 null</summary>
...
<details><summary>#### 组件 ref 的获取过程</summary>
...
<details><summary>#### TypeScript 中获取子组件暴露内容的类型</summary>
...
<details><summary>#### v-model 的编译转换</summary>
...
<details><summary>#### v-model 修饰符的作用</summary>
...
<details><summary>#### modelValue/update:modelValue 的编译展开</summary>
...
<details><summary>#### 从 Vue 2 迁移到 Vue 3 的 v-model 变化</summary>
...
<details><summary>#### 多 v-model 的编译展开</summary>
...
<details><summary>#### 默认 v-model 和命名 v-model 混用</summary>
...
<details><summary>#### 修饰符的编译处理</summary>
...
<details><summary>#### type="number" 不等于 .number</summary>
...
<details><summary>#### 自定义修饰符的传递机制</summary>
...
<details><summary>#### 命名 v-model 的修饰符 prop 名</summary>
...
<details><summary>#### mitt 的实现原理</summary>
...
<details><summary>#### 忘记取消监听导致内存泄漏</summary>
...
<details><summary>#### Pinia 实现全局共享的机制</summary>
...
<details><summary>#### 解构 Store 丢失响应性</summary>
...
<details><summary>#### 三阶段的协作流程</summary>
...
<details><summary>#### 如何查看编译后的渲染函数</summary>
...
<details><summary>#### 解析器的核心逻辑</summary>
...
<details><summary>#### 标签未正确闭合的错误</summary>
...
<details><summary>#### Transform 的插件化架构</summary>
...
<details><summary>#### Transform 阶段的进入/退出机制</summary>
...
<details><summary>#### Codegen 的递归生成逻辑</summary>
...
<details><summary>#### 生成代码中的 PatchFlag 数字含义</summary>
...
<details><summary>#### VNode 的创建和使用流程</summary>
...
<details><summary>#### VNode 是一次性的还是可复用的</summary>
...
<details><summary>#### createVNode 函数的处理逻辑</summary>
...
<details><summary>#### key 的选择策略</summary>
...
<details><summary>#### Patch 的完整判断流程</summary>
...
<details><summary>#### 为什么不做跨层级比较</summary>
...
<details><summary>#### Vue 3 Diff 算法的核心流程</summary>
...
<details><summary>#### 没有 key 时的就地更新策略</summary>
...
<details><summary>#### 快速路径的触发场景</summary>
...
<details><summary>#### 如何让更多节点命中快速路径</summary>
...
<details><summary>#### keyed Diff 的映射和匹配</summary>
...
<details><summary>#### 用数组索引做 key 的问题</summary>
...
<details><summary>#### PatchFlag 在 Patch 时的作用</summary>
...
<details><summary>#### 什么情况下 PatchFlag 会变成 FULL_PROPS</summary>
...
<details><summary>#### 位掩码的运算逻辑</summary>
...
<details><summary>#### 如何避免退化为 FULL_PROPS</summary>
...
<details><summary>#### 静态提升的判断规则</summary>
...
<details><summary>#### 如何确认静态提升是否生效</summary>
...
<details><summary>#### Block 树如何跳过静态节点</summary>
...
<details><summary>#### 动态绑定会阻止静态跳过</summary>
...
<details><summary>#### 事件缓存的工作机制</summary>
...
<details><summary>#### 内联函数与缓存的关系</summary>
...
<details><summary>#### v-once 的编译和运行时处理</summary>
...
<details><summary>#### v-once 导致数据更新不生效</summary>
...
<details><summary>#### v-memo 的编译和运行时处理</summary>
...
<details><summary>#### v-memo 的依赖数组遗漏导致不更新</summary>
...
<details><summary>#### Block 的收集机制</summary>
...
<details><summary>#### v-if/v-for 为什么需要独立的 Block</summary>
...
<details><summary>#### 编译时与运行时的分工</summary>
...
<details><summary>#### 手写渲染函数能享受编译优化吗</summary>
...
<details><summary>#### KeepAlive 的缓存机制</summary>
...
<details><summary>#### KeepAlive 只能有一个直接子组件</summary>
...
<details><summary>#### include 的匹配逻辑</summary>
...
<details><summary>#### 组件没有 name 导致 include 不生效</summary>
...
<details><summary>#### exclude 的判断流程</summary>
...
<details><summary>#### 动态修改 exclude 清理已缓存的组件</summary>
...
<details><summary>#### LRU 缓存淘汰机制</summary>
...
<details><summary>#### max 值设置多少合适</summary>
...
<details><summary>#### activated/deactivated 的触发机制</summary>
...
<details><summary>#### 区分首次挂载和后续激活</summary>
...
<details><summary>#### Teleport 的 DOM 移动机制</summary>
...
<details><summary>#### 目标容器不存在导致报错</summary>
...
<details><summary>#### to 属性的解析和移动</summary>
...
<details><summary>#### 目标容器还不存在时的处理</summary>
...
<details><summary>#### disabled 的切换处理</summary>
...
<details><summary>#### disabled 切换时的过渡效果</summary>
...
<details><summary>#### defer 的实现机制</summary>
...
<details><summary>#### defer 之前的替代方案</summary>
...
<details><summary>#### Transition 类名的添加时机</summary>
...
<details><summary>#### CSS transition 和 CSS animation 的区别</summary>
...
<details><summary>#### 进入类名的添加和移除时序</summary>
...
<details><summary>#### 进入动画不生效</summary>
...
<details><summary>#### 离开类名的时序和 DOM 移除</summary>
...
<details><summary>#### 进入和离开使用不同的动画时长</summary>
...
<details><summary>#### mode 对动画时序的控制</summary>
...
<details><summary>#### 不使用 mode 时布局跳动</summary>
...
<details><summary>#### TransitionGroup 的渲染和动画机制</summary>
...
<details><summary>#### 移动动画不流畅</summary>
...
<details><summary>#### key 在 TransitionGroup 中的匹配逻辑</summary>
...
<details><summary>#### 没有天然 id 时如何生成 key</summary>
...
<details><summary>#### FLIP 动画的实现步骤</summary>
...
<details><summary>#### 移动动画不生效</summary>
...
<details><summary>#### Suspense 的异步依赖收集</summary>
...
<details><summary>#### Suspense 配合 RouterView 使用</summary>
...
<details><summary>#### fallback 的渲染和切换时机</summary>
...
<details><summary>#### Suspense 的状态流转</summary>
...
<details><summary>#### 实现重试功能</summary>
...
<details><summary>#### onBeforeMount 在组件生命周期中的位置</summary>
...
<details><summary>#### onBeforeMount 中能否访问 DOM</summary>
...
<details><summary>#### onMounted 的执行时机</summary>
...
<details><summary>#### onMounted 中绑定事件需要在卸载时清理</summary>
...
<details><summary>#### onBeforeUpdate 的执行时机</summary>
...
<details><summary>#### 不要在 onBeforeUpdate 中修改响应式数据</summary>
...
<details><summary>#### onUpdated 的执行顺序</summary>
...
<details><summary>#### 不要在 onUpdated 中修改导致更新的数据</summary>
...
<details><summary>#### onBeforeUnmount 的执行时机</summary>
...
<details><summary>#### 选择 onBeforeUnmount 还是 onUnmounted</summary>
...
<details><summary>#### onUnmounted 的执行时机</summary>
...
<details><summary>#### 错误传播机制</summary>
...
<details><summary>#### onErrorCaptured 无法捕获的错误</summary>
...
<details><summary>#### onRenderTracked 的触发机制</summary>
...
<details><summary>#### onRenderTracked 触发次数太多难以阅读</summary>
...
<details><summary>#### onRenderTriggered 的触发机制</summary>
...
<details><summary>#### 组件频繁重渲染的排查</summary>
...
<details><summary>#### onActivated 的触发机制</summary>
...
<details><summary>#### onDeactivated 的触发机制</summary>
...
<details><summary>#### activated 和 deactivated 必须配对使用</summary>
...
<details><summary>#### 完整的生命周期时序</summary>
...
<details><summary>#### 父组件 onMounted 中访问子组件的 DOM</summary>
...
<details><summary>#### 两种 API 的执行时序</summary>
...
<details><summary>#### Options API 迁移到 Composition API</summary>
...
<details><summary>#### defineStore 的工作机制</summary>
...
<details><summary>#### Store ID 命名冲突</summary>
...
<details><summary>#### State 的响应式处理</summary>
...
<details><summary>#### TypeScript 中定义 State 类型</summary>
...
<details><summary>#### Getters 的缓存实现</summary>
...
<details><summary>#### Getter 访问其他 Store 的状态</summary>
...
<details><summary>#### 返回函数的 Getter 为什么没有缓存</summary>
...
<details><summary>#### 在模板中频繁调用返回函数的 Getter</summary>
...
<details><summary>#### 异步 Action 的执行机制</summary>
...
<details><summary>#### Action 中使用其他 Store</summary>
...
<details><summary>#### 同步 Action 与直接修改 State 的区别</summary>
...
<details><summary>#### 同步 Action 中修改多个属性的性能</summary>
...
<details><summary>#### storeToRefs 的工作机制</summary>
...
<details><summary>#### 解构后修改 ref 值是否同步到 Store</summary>
...
<details><summary>#### $patch 的合并与更新机制</summary>
...
<details><summary>#### 对象形式 $patch 对嵌套对象的处理</summary>
...
<details><summary>#### $reset 的工作机制</summary>
...
<details><summary>#### 为 Setup Store 实现通用 $reset 插件</summary>
...
<details><summary>#### $subscribe 的触发机制</summary>
...
<details><summary>#### $subscribe 与 watch 的选择</summary>
...
<details><summary>#### $onAction 的触发时序</summary>
...
<details><summary>#### 在 $onAction 中修改 Action 的返回值</summary>
...
<details><summary>#### Pinia 的扁平化架构</summary>
...
<details><summary>#### 避免循环依赖</summary>
...
<details><summary>#### Pinia 插件的执行机制</summary>
...
<details><summary>#### 插件添加的属性在 TypeScript 中没有类型提示</summary>
...
<details><summary>#### createRouter 的初始化流程</summary>
...
<details><summary>#### router.isReady() 的作用</summary>
...
<details><summary>#### History API 的路由实现</summary>
...
<details><summary>#### 部署后刷新页面 404</summary>
...
<details><summary>#### Hash 路由的工作机制</summary>
...
<details><summary>#### Hash 模式下锚点定位失效</summary>
...
<details><summary>#### 404 处理和 SSR 的路由解析</summary>
...
<details><summary>#### 服务器返回正确的 404 状态码</summary>
...
<details><summary>#### Hash 模式的兼容性原理</summary>
...
<details><summary>#### 从 Hash 模式迁移到 History 模式</summary>
...
<details><summary>#### 路由匹配的优先级</summary>
...
<details><summary>#### meta 类型在 TypeScript 中的扩展</summary>
...
<details><summary>#### props 解耦的工作机制</summary>
...
<details><summary>#### params 值是字符串，需要类型转换</summary>
...
<details><summary>#### 嵌套路由的匹配与渲染</summary>
...
<details><summary>#### 无组件的父路由（纯路径分组）</summary>
...
<details><summary>#### 命名视图的匹配机制</summary>
...
<details><summary>#### 某些路由不需要全部命名视图</summary>
...
<details><summary>#### redirect 的导航流程</summary>
...
<details><summary>#### 重定向导致无限循环</summary>
...
<details><summary>#### alias 的匹配机制</summary>
...
<details><summary>#### alias 对 SEO 的影响</summary>
...
<details><summary>#### 懒加载的构建与运行时机制</summary>
...
<details><summary>#### 预加载提升用户体验</summary>
...
<details><summary>#### beforeEach 在导航流程中的位置</summary>
...
<details><summary>#### 避免无限重定向</summary>
...
<details><summary>#### beforeResolve 在导航流程中的位置</summary>
...
<details><summary>#### beforeEach 和 beforeResolve 如何选择</summary>
...
<details><summary>#### afterEach 在导航流程中的位置</summary>
...
<details><summary>#### afterEach 与 beforeEach 配合使用进度条</summary>
...
<details><summary>#### beforeEnter 的执行时机</summary>
...
<details><summary>#### 复用守卫函数</summary>
...
<details><summary>#### beforeRouteEnter 的执行时机</summary>
...
<details><summary>#### Composition API 中如何实现 beforeRouteEnter 的功能</summary>
...
<details><summary>#### beforeRouteUpdate 的触发条件</summary>
...
<details><summary>#### beforeRouteUpdate 与 watch 的选择</summary>
...
<details><summary>#### beforeRouteLeave 的执行时机</summary>
...
<details><summary>#### 配合浏览器的 beforeunload 事件</summary>
...
<details><summary>#### next 与返回值的对应关系</summary>
...
<details><summary>#### 从 next 迁移到返回值</summary>
...
<details><summary>#### return false 的处理流程</summary>
...
<details><summary>#### return false 后地址栏异常</summary>
...
<details><summary>#### 返回路由对象的导航流程</summary>
...
<details><summary>#### 无限重定向循环</summary>
...
<details><summary>#### useRoute 的响应式机制</summary>
...
<details><summary>#### useRoute 的属性解构丢失响应性</summary>
...
<details><summary>#### useRouter 与 useRoute 的关系</summary>
...
<details><summary>#### 在非组件环境中使用 router</summary>
...
<details><summary>#### router.push 的导航流程</summary>
...
<details><summary>#### path 和 params 不能同时使用</summary>
...
<details><summary>#### push 与 replace 的历史记录区别</summary>
...
<details><summary>#### 何时用 push 何时用 replace</summary>
...
<details><summary>#### go/back/forward 与浏览器历史的关系</summary>
...
<details><summary>#### 没有历史记录时的后退处理</summary>
...
<details><summary>#### params 与 query 的 URL 编码</summary>
...
<details><summary>#### params 和 query 值都是字符串</summary>
...
<details><summary>#### scrollBehavior 的执行时机</summary>
...
<details><summary>#### 固定头部导致锚点被遮挡</summary>
...
<details><summary>#### 双向链表依赖追踪</summary>
...
<details><summary>#### 升级到 Vue 3.5 是否需要修改代码</summary>
...
<details><summary>#### Map/Set 的精确依赖追踪</summary>
...
<details><summary>#### 什么时候用 reactive Map 而不是 reactive Object</summary>
...
<details><summary>#### useTemplateRef 的工作机制</summary>
...
<details><summary>#### useTemplateRef 在 v-for 中的使用</summary>
...
<details><summary>#### defer Teleport 的渲染时序</summary>
...
<details><summary>#### defer 会影响 Teleport 内容的渲染性能吗</summary>
...
<details><summary>#### onEffectCleanup 的执行时机</summary>
...
<details><summary>#### 在 await 之后调用 onEffectCleanup 不生效</summary>
...
<details><summary>#### shallowRef 与 ref 的响应式差异</summary>
...
<details><summary>#### shallowRef 中修改深层属性后界面不更新</summary>
