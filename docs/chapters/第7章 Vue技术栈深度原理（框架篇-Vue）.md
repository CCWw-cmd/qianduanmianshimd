...
2. 渲染函数执行
   → 模板中使用了 &lbrace;&lbrace; state.count &rbrace;&rbrace;
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;&lbrace;&lbrace; state.user.name &rbrace;&rbrace; - &lbrace;&lbrace; state.user.address.city &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;标签: &lbrace;&lbrace; state.tags.join(", ") &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;&lbrace;&lbrace; state.count &rbrace;&rbrace; - &lbrace;&lbrace; state.name &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;!-- 模板中自动解包，不需要 .value --&gt;
    &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; message &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; user.name &rbrace;&rbrace; - &lbrace;&lbrace; user.age &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;!-- 在模板中：顶层 ref 自动解包 --&gt;
    &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;       &lt;!-- 不需要 count.value --&gt;
    &lt;p&gt;&lbrace;&lbrace; message &rbrace;&rbrace;&lt;/p&gt;     &lt;!-- 不需要 message.value --&gt;
    &lt;p&gt;&lbrace;&lbrace; user.name &rbrace;&rbrace;&lt;/p&gt;   &lt;!-- user 自动解包后访问 .name --&gt;
...
1. Vue 编译器处理模板时
   → &lbrace;&lbrace; count &rbrace;&rbrace; 编译为 _ctx.count
   → _ctx 是组件的渲染上下文代理
...
&lt;template&gt;
    &lt;div&gt;
        &lt;!-- 顶层 ref 自动解包 --&gt;
        &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;            &lt;!-- 显示 0，不需要 count.value --&gt;
        &lt;p&gt;&lbrace;&lbrace; message &rbrace;&rbrace;&lt;/p&gt;          &lt;!-- 显示 "你好" --&gt;
        &lt;p&gt;&lbrace;&lbrace; user.name &rbrace;&rbrace;&lt;/p&gt;        &lt;!-- user 解包后访问 .name --&gt;

        &lt;!-- 表达式中也自动解包 --&gt;
        &lt;p&gt;&lbrace;&lbrace; count + 1 &rbrace;&rbrace;&lt;/p&gt;        &lt;!-- 显示 1 --&gt;
        &lt;p&gt;&lbrace;&lbrace; message.split("").reverse().join("") &rbrace;&rbrace;&lt;/p&gt;

        &lt;!-- v-bind 中自动解包 --&gt;
        &lt;div :id="`item-${count}`"&gt;绑定属性&lt;/div&gt;

        &lt;!-- 事件处理中自动解包 --&gt;
        &lt;button @click="count++"&gt;count: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/button&gt;
        &lt;!-- count++ 等价于 count.value++ --&gt;

        &lt;!-- v-for 中自动解包 --&gt;
        &lt;ul&gt;
            &lt;li v-for="(item, i) in list" :key="i"&gt;&lbrace;&lbrace; item &rbrace;&rbrace;&lt;/li&gt;
        &lt;/ul&gt;

        &lt;!-- reactive 中的 ref 自动解包 --&gt;
        &lt;p&gt;&lbrace;&lbrace; state.total &rbrace;&rbrace;&lt;/p&gt;     &lt;!-- 显示 100 --&gt;

        &lt;!-- 普通对象中的 ref 不会自动解包 --&gt;
        &lt;p&gt;&lbrace;&lbrace; plain.num &rbrace;&rbrace;&lt;/p&gt;       &lt;!-- 显示 ref 对象，不是 42 --&gt;
        &lt;p&gt;&lbrace;&lbrace; plain.num.value &rbrace;&rbrace;&lt;/p&gt; &lt;!-- 需要手动 .value 才显示 42 --&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
```
模板编译阶段：
  &lbrace;&lbrace; count &rbrace;&rbrace;
...
// &lbrace;&lbrace; obj.count &rbrace;&rbrace; 显示的是 ref 对象

// 方案1：用 reactive 包裹
const state = reactive({ count: ref(0) });
// &lbrace;&lbrace; state.count &rbrace;&rbrace; 自动解包，显示 0

// 方案2：将 ref 提升为顶层变量
const count = ref(0);
// &lbrace;&lbrace; count &rbrace;&rbrace; 自动解包

// 方案3：在模板中手动 .value（不推荐）
// &lbrace;&lbrace; obj.count.value &rbrace;&rbrace;
&lt;/script&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;count: &lbrace;&lbrace; state.count &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;nested.value: &lbrace;&lbrace; state.nested.value &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; state.count &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; fullName &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;p&gt;姓: &lbrace;&lbrace; firstName &rbrace;&rbrace;，名: &lbrace;&lbrace; lastName &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p id="count"&gt;&lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;ul&gt;
        &lt;li v-for="item in results" :key="item.id"&gt;&lbrace;&lbrace; item.title &rbrace;&rbrace;&lt;/li&gt;
    &lt;/ul&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; name &rbrace;&rbrace; - &lbrace;&lbrace; age &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; fullName &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;总价: &lbrace;&lbrace; totalPrice &rbrace;&rbrace; 元&lt;/p&gt;
...
// 模板中 &lbrace;&lbrace; sortedList &rbrace;&rbrace; 多次引用只计算一次
// 模板中 &lbrace;&lbrace; getSortedList() &rbrace;&rbrace; 每次引用都计算
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace; × 2 = &lbrace;&lbrace; doubleCount &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;&lbrace;&lbrace; user.name &rbrace;&rbrace;&lt;/p&gt;
        &lt;button @click="increment"&gt;+1&lt;/button&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
setup 的返回值处理：
  → 返回对象：proxyRefs(返回对象)
    → ref 在模板中自动解包
    → { count } → 模板中 &lbrace;&lbrace; count &rbrace;&rbrace; 而非 &lbrace;&lbrace; count.value &rbrace;&rbrace;
...
&lt;template&gt;
    ...
    &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace; × 2 = &lbrace;&lbrace; double &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    ...
    &lt;!-- 导入的工具函数 --&gt;
    &lt;p&gt;&lbrace;&lbrace; formatDate(new Date()) &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;h1&gt;&lbrace;&lbrace; title &rbrace;&rbrace;&lt;/h1&gt;
    &lt;p&gt;数量: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; message &rbrace;&rbrace;&lt;/p&gt;
    &lt;span v-for="tag in tags" :key="tag"&gt;&lbrace;&lbrace; tag &rbrace;&rbrace;&lt;/span&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;ID: &lbrace;&lbrace; id &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;&lbrace;&lbrace; title &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;DataList :items="users"&gt;
        ...
        &lt;template #item="{ data, index }"&gt;
            &lt;span&gt;&lbrace;&lbrace; index + 1 &rbrace;&rbrace;. &lbrace;&lbrace; data.name &rbrace;&rbrace; (&lbrace;&lbrace; data.age &rbrace;&rbrace;岁)&lt;/span&gt;
        &lt;/template&gt;
...
&lt;template&gt;
    ...
    &lt;p&gt;输入内容: &lbrace;&lbrace; username &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;input
        ...
        v-model="model"
    /&gt;
    &lt;p&gt;修饰符: &lbrace;&lbrace; modifiers &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;p&gt;值: &lbrace;&lbrace; text &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; greeting &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;div :class="['card', `card-${size}`]"&gt;
        &lt;h3&gt;&lbrace;&lbrace; title &rbrace;&rbrace;&lt;/h3&gt;
        &lt;p&gt;分数: &lbrace;&lbrace; score &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;当前主题: &lbrace;&lbrace; theme &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;当前语言: &lbrace;&lbrace; locale &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;p&gt;祖先 count: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
    &lt;button @click="increment"&gt;+1&lt;/button&gt;
    &lt;ChildComponent /&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;后代 count: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;用户: &lbrace;&lbrace; user.name &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;div class="form-field" :class="attrs.class" :style="attrs.style"&gt;
        &lt;label v-if="label"&gt;&lbrace;&lbrace; label &rbrace;&rbrace;&lt;/label&gt;
        &lt;input v-bind="inputAttrs" /&gt;
        &lt;span v-if="error" class="error"&gt;&lbrace;&lbrace; error &rbrace;&rbrace;&lt;/span&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div class="form-item"&gt;
        &lt;label&gt;&lbrace;&lbrace; label &rbrace;&rbrace;&lt;/label&gt;
        &lt;!-- 将所有透传属性绑定到 input 上 --&gt;
        &lt;input v-bind="$attrs" /&gt;
        &lt;!-- 
...
&lt;template&gt;
    ...
    &lt;p&gt;输入值: &lbrace;&lbrace; username &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;p&gt;姓名：&lbrace;&lbrace; first &rbrace;&rbrace;&lbrace;&lbrace; last &rbrace;&rbrace;，年龄：&lbrace;&lbrace; userAge &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;input v-model="model" /&gt;
    &lt;!-- 调试用：查看当前修饰符 --&gt;
    &lt;!-- &lt;pre&gt;&lbrace;&lbrace; modifiers &rbrace;&rbrace;&lt;/pre&gt; --&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;nav&gt;
        ...
        &lt;template v-if="userStore.isLoggedIn"&gt;
            &lt;span&gt;&lbrace;&lbrace; userStore.name &rbrace;&rbrace;&lt;/span&gt;
...
const { code } = compile(`&lt;div&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/div&gt;`);
console.log(code);
// 输出生成的渲染函数代码
...
3. 遇到 '&lbrace;&lbrace;' → 识别为插值表达式
   → 解析表达式内容: 'title'
   → 遇到 '&rbrace;&rbrace;' → 插值解析完成
...
&lt;div&gt;
    &lt;h1&gt;静态标题&lt;/h1&gt;
    &lt;p :class="cls"&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/p&gt;
    &lt;ul v-if="show"&gt;
        &lt;li v-for="item in list" :key="item.id"&gt;&lbrace;&lbrace; item.name &rbrace;&rbrace;&lt;/li&gt;
    &lt;/ul&gt;
&lt;/div&gt;
```
...
3. transformText 处理 &lbrace;&lbrace; msg &rbrace;&rbrace;
   → 识别插值表达式
   → 添加 PatchFlag: TEXT (1)
...
&lt;template&gt;
    ...
    &lt;!-- v-once：手动标记一次性内容 --&gt;
    &lt;div v-once&gt;
        &lt;p&gt;&lbrace;&lbrace; initialData &rbrace;&rbrace;&lt;/p&gt;
        &lt;!-- 只渲染一次，后续更新跳过 --&gt;
    &lt;/div&gt;
    ...
    &lt;div v-memo="[item.id, item.selected]"&gt;
        ...
        &lt;p&gt;&lbrace;&lbrace; item.name &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;div&gt;
    ...
    &lt;span&gt;&lbrace;&lbrace; dynamicText &rbrace;&rbrace;&lt;/span&gt;
    &lt;footer&gt;
        &lt;p&gt;版权信息 2026&lt;/p&gt;
        &lt;p&gt;联系方式&lt;/p&gt;
    &lt;/footer&gt;
...
可以提升的条件：
  ...
  → 没有插值表达式 &lbrace;&lbrace; &rbrace;&rbrace;
  → 不是组件节点
  → 子节点也都是静态的（递归检查）

不能提升的情况：
  → 包含 :class、:style、:id 等动态绑定
  → 包含 &lbrace;&lbrace; expr &rbrace;&rbrace; 插值
  → 包含 v-if、v-for、v-show 等指令
  → 是组件节点（组件可能有内部状态）
  → ref 属性（需要运行时绑定）

静态属性对象也会被提升：
  &lt;div id="app" class="container"&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/div&gt;
...
&lt;div&gt;
    ...
    &lt;main&gt;
        ...
        &lt;!-- 唯一的动态内容 --&gt;
        &lt;span&gt;&lbrace;&lbrace; counter &rbrace;&rbrace;&lt;/span&gt;
    &lt;/main&gt;
    &lt;footer&gt;
        &lt;p&gt;版权所有 2026&lt;/p&gt;
    &lt;/footer&gt;
...
&lt;template&gt;
    &lt;!-- v-once：只渲染一次，后续更新跳过 --&gt;
    &lt;h1 v-once&gt;&lbrace;&lbrace; title &rbrace;&rbrace;&lt;/h1&gt;
    &lt;!-- 首次渲染显示 "初始标题" --&gt;
    &lt;!-- changeTitle() 后仍然显示 "初始标题" --&gt;

    &lt;!-- 没有 v-once：正常响应更新 --&gt;
    &lt;h2&gt;&lbrace;&lbrace; title &rbrace;&rbrace;&lt;/h2&gt;
    ...
    &lt;div v-once&gt;
        &lt;p&gt;用户协议内容...&lt;/p&gt;
        &lt;p&gt;这里有很多不需要更新的文字...&lt;/p&gt;
        &lt;p&gt;创建时间: &lbrace;&lbrace; new Date().toLocaleDateString() &rbrace;&rbrace;&lt;/p&gt;
        &lt;!-- 时间也只在首次渲染时计算，后续不更新 --&gt;
    &lt;/div&gt;

    &lt;!-- v-once 用于列表 --&gt;
    &lt;ul v-once&gt;
        &lt;li v-for="item in items" :key="item"&gt;&lbrace;&lbrace; item &rbrace;&rbrace;&lt;/li&gt;
    &lt;/ul&gt;
    &lt;!-- items 变化后列表不会更新 --&gt;
...
&lt;template&gt;
    ...
    &lt;!-- &lt;p v-once&gt;计数: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt; --&gt;
    &lt;!-- count 变化后显示不会更新 --&gt;

    &lt;!-- 正确：只对确定不需要更新的内容使用 --&gt;
    &lt;p v-once&gt;创建时间: &lbrace;&lbrace; createdAt &rbrace;&rbrace;&lt;/p&gt;
    &lt;!-- createdAt 是不变的，适合 v-once --&gt;

    &lt;!-- 需要更新的内容不要用 v-once --&gt;
    &lt;p&gt;计数: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;div v-memo="[valueA, valueB]"&gt;
        ...
        &lt;p&gt;&lbrace;&lbrace; valueA &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;&lbrace;&lbrace; valueB &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;&lbrace;&lbrace; valueC &rbrace;&rbrace;&lt;/p&gt;
        &lt;!-- valueC 变化不会触发此区域更新 --&gt;
    &lt;/div&gt;
    ...
    &lt;div v-memo="[]"&gt;
        &lt;!-- 空数组永远不变 → 永远不更新 --&gt;
        &lt;p&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;div&gt;                           &lt;!-- Block（根节点） --&gt;
    ...
    &lt;p&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/p&gt;             &lt;!-- 动态，加入 dynamicChildren --&gt;
    &lt;div&gt;
...
&lt;div&gt;            ← Block
    &lt;p&gt;&lbrace;&lbrace; a &rbrace;&rbrace;&lt;/p&gt;
    &lt;div v-if="show"&gt;
        &lt;span&gt;&lbrace;&lbrace; b &rbrace;&rbrace;&lt;/span&gt;
    &lt;/div&gt;
    &lt;p&gt;&lbrace;&lbrace; c &rbrace;&rbrace;&lt;/p&gt;
&lt;/div&gt;
...
&lt;template&gt;
    &lt;div class="page"&gt;
        ...
        &lt;main&gt;
            ...
            &lt;p&gt;&lbrace;&lbrace; description &rbrace;&rbrace;&lt;/p&gt;
...
1. 编译阶段（构建时）
   ...
   → &lt;p&gt;&lbrace;&lbrace; description &rbrace;&rbrace;&lt;/p&gt; → PatchFlag = 1 (TEXT)
...
&lt;template&gt;
    &lt;div class="tabs"&gt;
        ...
        &gt;
            &lbrace;&lbrace; tab.label &rbrace;&rbrace;
        &lt;/button&gt;
    &lt;/div&gt;
...
&lt;template&gt;
    &lt;div&gt;
        ...
        &lt;p&gt;已输入: &lbrace;&lbrace; formData &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;ul&gt;
        &lt;li v-for="item in data" :key="item.id"&gt;&lbrace;&lbrace; item.name &rbrace;&rbrace;&lt;/li&gt;
    &lt;/ul&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;TransitionGroup name="list" tag="ul"&gt;
        &lt;li v-for="item in items" :key="item.id"&gt;
            &lbrace;&lbrace; item.text &rbrace;&rbrace;
...
&lt;template&gt;
    &lt;div class="dashboard"&gt;
        &lt;h1&gt;欢迎, &lbrace;&lbrace; userData.name &rbrace;&rbrace;&lt;/h1&gt;
        &lt;div class="stats"&gt;
            &lt;p&gt;总访问量: &lbrace;&lbrace; statsData.visits &rbrace;&rbrace;&lt;/p&gt;
            &lt;p&gt;活跃用户: &lbrace;&lbrace; statsData.activeUsers &rbrace;&rbrace;&lt;/p&gt;
        &lt;/div&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;div v-if="error" class="error-state"&gt;
        &lt;p&gt;加载失败: &lbrace;&lbrace; error.message &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;div&gt;
        &lt;h1&gt;&lbrace;&lbrace; data.title &rbrace;&rbrace;&lt;/h1&gt;
        &lt;p&gt;&lbrace;&lbrace; data.content &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div v-if="loadError" class="inline-error"&gt;
        &lt;p&gt;数据加载失败: &lbrace;&lbrace; loadError &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
    &lt;div v-else&gt;
        &lt;p&gt;&lbrace;&lbrace; data.title &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div v-if="error"&gt;
        &lt;p&gt;出错了: &lbrace;&lbrace; error.message &rbrace;&rbrace;&lt;/p&gt;
        &lt;button @click="retry"&gt;重试&lt;/button&gt;
    &lt;/div&gt;
...
&lt;template&gt;
    ...
    &lt;/div&gt;
    &lt;div v-if="userData"&gt;
        &lt;p&gt;&lbrace;&lbrace; userData.name &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;button @click="count++"&gt;计数: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/button&gt;
    &lt;div ref="listRef" style="height: 200px; overflow: auto;"&gt;
        &lt;p v-for="i in count" :key="i"&gt;项目 &lbrace;&lbrace; i &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div ref="listRef" style="height: 200px; overflow: auto;"&gt;
        &lt;p v-for="(msg, i) in messages" :key="i"&gt;&lbrace;&lbrace; msg &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
...
&lt;template&gt;
    &lt;div v-if="data"&gt;&lbrace;&lbrace; data &rbrace;&rbrace;&lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div v-if="error" class="error-fallback"&gt;
        &lt;h3&gt;出错了&lt;/h3&gt;
        &lt;p&gt;&lbrace;&lbrace; error.message &rbrace;&rbrace;&lt;/p&gt;
        &lt;p class="error-info"&gt;错误来源: &lbrace;&lbrace; errorInfo &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;div&gt;&lbrace;&lbrace; data.title &rbrace;&rbrace;&lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;计数: &lbrace;&lbrace; count &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;姓名: &lbrace;&lbrace; user.name &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;年龄: &lbrace;&lbrace; user.age &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;p&gt;上次刷新: &lbrace;&lbrace; lastRefresh &rbrace;&rbrace;&lt;/p&gt;
        &lt;ul&gt;
            &lt;li v-for="item in dataList" :key="item.id"&gt;&lbrace;&lbrace; item.name &rbrace;&rbrace;&lt;/li&gt;
        &lt;/ul&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;ul&gt;
        &lt;li v-for="msg in messages" :key="msg.id"&gt;&lbrace;&lbrace; msg.text &rbrace;&rbrace;&lt;/li&gt;
    &lt;/ul&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; counterStore.count &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; counterStore.doubleCount &rbrace;&rbrace;&lt;/p&gt;
    &lt;button @click="counterStore.increment()"&gt;+1&lt;/button&gt;

    &lt;p&gt;&lbrace;&lbrace; userStore.userInfo &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; userStore.isLoggedIn ? "已登录" : "未登录" &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;商品数量: &lbrace;&lbrace; cartStore.itemCount &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;总价: &lbrace;&lbrace; cartStore.totalPrice &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;折后价: &lbrace;&lbrace; cartStore.discountedTotal &rbrace;&rbrace;&lt;/p&gt;
&lt;/template&gt;
```
    ...
    &lt;div&gt;
        ...
        &lt;ul&gt;
            &lt;li v-for="p in productStore.getProductsByCategory('电子')" :key="p.id"&gt;
                &lbrace;&lbrace; p.name &rbrace;&rbrace; - &lbrace;&lbrace; p.price &rbrace;&rbrace;元
            &lt;/li&gt;
        &lt;/ul&gt;
    &lt;/div&gt;
&lt;/template&gt;
...
&lt;template&gt;
    ...
    &lt;li v-for="p in electronics" :key="p.id"&gt;&lbrace;&lbrace; p.name &rbrace;&rbrace;&lt;/li&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;form @submit.prevent="handleLogin"&gt;
        ...
        &lt;button :disabled="userStore.loading"&gt;
            &lbrace;&lbrace; userStore.loading ? "登录中..." : "登录" &rbrace;&rbrace;
        &lt;/button&gt;
        &lt;p v-if="userStore.error" class="error"&gt;&lbrace;&lbrace; userStore.error &rbrace;&rbrace;&lt;/p&gt;
    &lt;/form&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;p&gt;计数: &lbrace;&lbrace; counter.count &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;步长: &lbrace;&lbrace; counter.step &rbrace;&rbrace;&lt;/p&gt;
    &lt;button @click="counter.increment()"&gt;+&lbrace;&lbrace; counter.step &rbrace;&rbrace;&lt;/button&gt;
    &lt;button @click="counter.decrement()"&gt;-&lbrace;&lbrace; counter.step &rbrace;&rbrace;&lt;/button&gt;
...
&lt;template&gt;
    ...
    &lt;p&gt;姓名: &lbrace;&lbrace; name &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;年龄: &lbrace;&lbrace; age &rbrace;&rbrace;&lt;/p&gt;
    &lt;p&gt;&lbrace;&lbrace; isLoggedIn ? "已登录" : "未登录" &rbrace;&rbrace;&lt;/p&gt;
...
&lt;template&gt;
    &lt;p&gt;&lbrace;&lbrace; count &rbrace;&rbrace; x 2 = &lbrace;&lbrace; doubleCount &rbrace;&rbrace;&lt;/p&gt;
    &lt;button @click="increment()"&gt;+1&lt;/button&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div class="not-found"&gt;
        &lt;h1&gt;404&lt;/h1&gt;
        &lt;p&gt;页面 "&lbrace;&lbrace; route.fullPath &rbrace;&rbrace;" 不存在&lt;/p&gt;
...
&lt;template&gt;
    &lt;div&gt;用户ID: &lbrace;&lbrace; id &rbrace;&rbrace;&lt;/div&gt;
&lt;/template&gt;
...
&lt;template&gt;
    &lt;div v-if="post"&gt;&lbrace;&lbrace; post.title &rbrace;&rbrace;&lt;/div&gt;
    &lt;div v-else&gt;加载中...&lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    ...
    &lt;div v-else-if="userData"&gt;
        &lt;h2&gt;&lbrace;&lbrace; userData.name &rbrace;&rbrace;&lt;/h2&gt;
        &lt;p&gt;&lbrace;&lbrace; userData.email &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
...
&lt;template&gt;
    &lt;div&gt;
        &lt;h1&gt;&lbrace;&lbrace; pageTitle &rbrace;&rbrace;&lt;/h1&gt;
        &lt;p&gt;路径: &lbrace;&lbrace; route.path &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;完整路径: &lbrace;&lbrace; route.fullPath &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;用户ID: &lbrace;&lbrace; route.params.id &rbrace;&rbrace;&lt;/p&gt;
        &lt;p&gt;页码: &lbrace;&lbrace; route.query.page || 1 &rbrace;&rbrace;&lt;/p&gt;
    &lt;/div&gt;
&lt;/template&gt;
```
