...
<details><summary>#### 大整数精度丢失</summary>
...
<details><summary>#### 模板字符串的表达式嵌入</summary>
...
<details><summary>#### string 和 String 有什么区别</summary>
...
<details><summary>#### 模板字符串中如何嵌入反引号</summary>
...
<details><summary>#### 为什么 if 中可以放非 boolean 值但 TypeScript 不报错</summary>
...
<details><summary>#### Boolean 对象的陷阱</summary>
...
<details><summary>#### typeof null 为什么返回 "object"</summary>
...
<details><summary>#### null 和 undefined 在项目中如何选择</summary>
...
<details><summary>#### 可选属性 `?` 和 `| undefined` 有什么区别</summary>
...
<details><summary>#### 如何同时检查 null 和 undefined</summary>
...
<details><summary>#### unique symbol 的限制</summary>
...
<details><summary>#### Symbol 能不能作为 Map 的键</summary>
...
<details><summary>#### Symbol 和 ES2022 的私有字段 # 有什么区别</summary>
...
<details><summary>#### JSON.stringify 遇到 bigint 会报错</summary>
...
<details><summary>#### bigint 能和 number 做比较但不能做运算</summary>
...
<details><summary>#### object 类型能访问属性吗</summary>
...
<details><summary>#### 什么时候用 object，什么时候用 Record 或接口</summary>
...
<details><summary>#### Array\&lt;T\> 和 T[] 到底用哪个</summary>
...
<details><summary>#### 为什么空数组 [] 的类型是 never[]</summary>
...
<details><summary>#### 联合类型数组的括号问题</summary>
...
<details><summary>#### 元组的长度属性</summary>
...
<details><summary>#### 元组和数组在赋值时的兼容性</summary>
...
<details><summary>#### 元组的 push 陷阱</summary>
...
<details><summary>#### 可选元素和 undefined 的区别</summary>
...
<details><summary>#### 剩余元素放在中间时的推断</summary>
...
<details><summary>#### readonly 是编译期还是运行时的</summary>
...
<details><summary>#### 为什么普通数组可以赋值给 readonly 数组</summary>
...
<details><summary>#### 索引签名访问不存在的键不报错</summary>
...
<details><summary>#### 固定属性和索引签名的类型冲突</summary>
...
<details><summary>#### 索引签名访问不存在的键为什么不报错</summary>
...
<details><summary>#### 具名属性类型和索引签名冲突</summary>
...
<details><summary>#### for...in 遍历数字索引时键变成了字符串</summary>
...
<details><summary>#### 数组类型和数字索引签名的关系</summary>
...
<details><summary>#### 参数与返回类型对照</summary>
...
<details><summary>#### 返回类型应该显式标注还是让 TS 推断</summary>
...
<details><summary>#### void 和 undefined 作为返回类型的区别</summary>
...
<details><summary>#### 默认参数放在中间位置时如何跳过</summary>
...
<details><summary>#### null 不会触发默认值</summary>
...
<details><summary>#### 剩余参数和展开运算符的区别</summary>
...
<details><summary>#### this 参数和普通参数有什么区别</summary>
...
<details><summary>#### 箭头函数能声明 this 参数吗</summary>
...
<details><summary>#### 重载和联合类型该用哪个</summary>
...
<details><summary>#### 为什么不能直接按实现签名调用</summary>
...
<details><summary>#### 为什么对象属性不自动推断为字面量类型</summary>
...
<details><summary>#### 字面量类型和枚举应该用哪个</summary>
...
<details><summary>#### 模板字面量类型展开太多会怎样</summary>

联合类型成员有上限（通常约 10 万个），如果笛卡尔积展开后超过限制会报编译错误。避免对成员过多的联合类型做模板拼接。

</details>
<details><summary>#### 模板字面量类型和运行时模板字符串的关系</summary>
...
<details><summary>#### 如何减少项目中的 any</summary>
...
<details><summary>#### any 和 as any 的区别</summary>
...
<details><summary>#### unknown 和 any 在函数参数中的选择</summary>

函数参数用 unknown 代替 any，强制函数内部做类型检查。返回值用 unknown 代替 any，强制调用者做类型检查。两者都比 any 更安全。

</details>
<details><summary>#### unknown 类型可以做哪些操作</summary>
...
<details><summary>#### void 和 undefined 在函数返回类型中有什么区别</summary>
...
<details><summary>#### 为什么 void 回调可以返回值</summary>
...
<details><summary>#### 枚举和字面量联合类型应该用哪个</summary>
...
<details><summary>#### 数值枚举的类型安全隐患</summary>
...
<details><summary>#### isolatedModules 模式下的限制</summary>
...
<details><summary>#### 联合类型成员太多影响性能吗</summary>

TypeScript 编译器处理联合类型有内部限制，极端情况下（成员超过数万）会导致编译变慢。正常业务代码中几十个成员的联合类型没有问题。

</details>
<details><summary>#### 联合类型和交叉类型的区别</summary>
...
<details><summary>#### 同名属性类型冲突怎么办</summary>
...
<details><summary>#### 交叉类型和 extends 继承的区别</summary>
...
<details><summary>#### 对象字面量的多余属性检查</summary>
...
<details><summary>#### interface 和 class 的关系</summary>
...
<details><summary>#### 可选属性和 `| undefined` 的区别</summary>
...
<details><summary>#### readonly 是运行时还是编译期的</summary>

纯编译期。readonly 在编译后完全消失，运行时没有任何保护。如果需要运行时冻结，配合 `Object.freeze()` 使用。

</details>
<details><summary>#### 如何实现深层只读</summary>
...
<details><summary>#### 方法简写和属性函数在类型检查上有什么区别</summary>
...
<details><summary>#### 调用签名和函数类型别名的区别</summary>
...
<details><summary>#### 为什么不能直接用类的类型作为参数类型</summary>
...
<details><summary>#### 固定属性类型和索引签名冲突</summary>
...
<details><summary>#### 索引签名和 Record 哪个更好</summary>
...
<details><summary>#### 继承时属性类型可以改变吗</summary>

子接口可以重新声明父接口的属性，但新类型必须是原类型的子类型（窄化）。不能把 string 改成 number。

</details>
<details><summary>#### 多继承冲突怎么处理</summary>
...
<details><summary>#### 合并时属性类型冲突怎么办</summary>
...
<details><summary>#### 声明合并和继承的区别</summary>
...
<details><summary>#### 团队应该统一用哪个</summary>
...
<details><summary>#### 性能有差异吗</summary>
...
<details><summary>#### 联合类型成员太多怎么办</summary>

联合类型成员数量没有硬性限制，但超过数百个时编译性能可能下降。可以考虑用索引签名、Record 或枚举替代超大联合类型。

</details>
<details><summary>#### 联合类型的值只能访问共有属性吗</summary>
...
<details><summary>#### 映射类型和索引签名的区别</summary>

索引签名 `{ [key: string]: T }` 描述动态键名的类型。映射类型 `{ [K in Keys]: T }` 是遍历已知的键集合生成新类型。两者语法相似但用途不同。

</details>
<details><summary>#### 映射类型只能用 type 吗</summary>
...
<details><summary>#### Object.keys 返回 string[] 而不是 (keyof T)[]</summary>

这是 TypeScript 的有意设计。由于结构类型系统允许对象有多余属性，Object.keys 可能返回接口中没有定义的键。如果确信对象没有多余属性，可以用 `as (keyof T)[]` 断言。

</details>
<details><summary>#### keyof 联合类型为什么只有共有键</summary>
...
<details><summary>#### 非空断言和 as 断言的区别</summary>

非空断言 `x!` 只移除 null 和 undefined，不改变其他类型。`x as T` 可以将类型断言为任何兼容的类型。非空断言是类型断言的一种特殊简写形式。

</details>
<details><summary>#### 什么时候应该用可选链而不是非空断言</summary>
...
<details><summary>#### typeof null 的陷阱</summary>
...
<details><summary>#### typeof 能区分数组和普通对象吗</summary>
...
<details><summary>#### instanceof 能检查接口吗</summary>

不能。接口只存在于编译期，运行时完全消失。instanceof 需要运行时的构造函数。要检查是否满足接口形状，用 in 操作符或自定义类型谓词。

</details>
<details><summary>#### 跨 iframe 的 instanceof 问题</summary>
...
<details><summary>#### in 操作符会检查原型链吗</summary>

会。`"toString" in obj` 对任何对象都返回 true。进行 in 守卫时应检查对象自身的特有属性，避免使用原型链上的通用属性。

</details>
<details><summary>#### in 守卫和可辨识联合哪个更好</summary>
...
<details><summary>#### 辨识属性可以是数字或布尔字面量吗</summary>

可以。辨识属性的值只要是字面量类型就行，不限于字符串。`{ ok: true; data: T } | { ok: false; error: E }` 就是用布尔字面量做辨识。

</details>
<details><summary>#### 可辨识联合和普通联合类型有什么区别</summary>
...
<details><summary>#### 推断出的类型不够精确怎么办</summary>
...
<details><summary>#### 多个参数推断冲突时怎么处理</summary>
...
<details><summary>#### 泛型接口和泛型方法的区别</summary>

泛型接口的类型参数在接口名后声明，整个接口共享同一个 T。泛型方法的类型参数在方法名后声明，每次调用可以是不同的 T。两者可以组合使用。

</details>
<details><summary>#### 泛型接口必须指定类型参数吗</summary>
...
<details><summary>#### 泛型类的静态成员能使用类型参数吗</summary>
...
<details><summary>#### 泛型类和泛型工厂函数哪个更好</summary>
...
<details><summary>#### 什么是"裸类型参数"</summary>
...
<details><summary>#### 为什么 never 在分布式条件类型中返回 never</summary>
...
<details><summary>#### infer 可以在 extends 子句外使用吗</summary>

不能。infer 只能在条件类型的 extends 子句中声明。在 true 分支中使用推断出的类型变量，在 false 分支中该变量不可用。

</details>
<details><summary>#### 同名 infer 出现多次会怎样</summary>
...
<details><summary>#### 映射类型会保留原始修饰符吗</summary>
...
<details><summary>#### -? 会移除 undefined 吗</summary>
...
<details><summary>#### TypeScript 内置有 Mutable 工具类型吗</summary>
...
<details><summary>#### 模板字面量类型的组合数量有限制吗</summary>

有。联合类型展开的笛卡尔积不能超过一定数量（TypeScript 限制约 10 万个成员）。如果组合过多会报错。实际中应避免过多联合类型的交叉展开。

</details>
<details><summary>#### 模板字面量类型能做完整的字符串解析吗</summary>
...
<details><summary>#### 递归类型有深度限制吗</summary>
...
<details><summary>#### 接口递归和类型别名递归有什么区别</summary>
...
<details><summary>#### 为什么 TypeScript 的数组是协变的</summary>

这是一种有意的设计妥协。严格来说数组是可变的应该是不变的，但不变会让很多合理的代码报错（如把 Dog[] 传给接受 Animal[] 的函数）。TypeScript 选择了实用性优先。

</details>
<details><summary>#### strictFunctionTypes 有什么影响</summary>
...
<details><summary>#### Partial 是浅层的还是深层的</summary>

Partial 只处理第一层属性，嵌套对象的属性不会变为可选。需要深层可选要自定义 DeepPartial。

</details>
<details><summary>#### Partial&lt;T> 会让所有属性值可能是 undefined 吗</summary>
...
<details><summary>#### Required 会移除属性值中的 undefined 吗</summary>

`-?` 会移除由可选标记引入的 `| undefined`。但如果属性原本显式定义为 `string | undefined`，Required 不会移除这个 undefined。

</details>
<details><summary>#### Required 是深层的吗</summary>
...
<details><summary>#### Readonly 是浅层的吗</summary>
...
<details><summary>#### Record&lt;string, T> 和 { [key: string]: T } 有区别吗</summary>
...
<details><summary>#### Pick 的第二个参数必须是 T 的键吗</summary>
...
<details><summary>#### Omit 的第二个参数可以传不存在的键吗</summary>
...
<details><summary>#### Exclude 和 Omit 的区别</summary>
...
<details><summary>#### Extract 和交叉类型 & 的区别</summary>
...
<details><summary>#### NonNullable 和非空断言 ! 的区别</summary>
...
<details><summary>#### ReturnType 能处理重载函数吗</summary>

对于重载函数，ReturnType 只返回最后一个重载签名的返回类型。如果需要所有重载的返回类型，需要手动处理。

</details>
<details><summary>#### 异步函数的 ReturnType 是什么</summary>
...
<details><summary>#### Parameters 能处理可选参数和剩余参数吗</summary>
...
<details><summary>#### 和 Parameters 的区别</summary>
...
<details><summary>#### 如果函数没有声明 this 参数，结果是什么</summary>
...
<details><summary>#### 和 Function.prototype.bind 的类型推断有什么关系</summary>
...
<details><summary>#### ThisType 和 this 参数声明有什么区别</summary>

`this` 参数声明用于单个函数（`function f(this: T)`），ThisType 用于整个对象字面量的所有方法。ThisType 更适合配置对象模式。

</details>
<details><summary>#### 必须开启 noImplicitThis 吗</summary>
...
<details><summary>#### Awaited 和手动写 `T extends Promise<infer U> ? U : T` 有什么区别</summary>

Awaited 能递归解包多层 Promise，手动写的只解包一层。Awaited 还处理了 thenable 对象和 null/undefined 等边界情况。

</details>
<details><summary>#### Awaited 之前怎么获取 Promise 内部类型</summary>
...
<details><summary>#### PropertyKey 和 keyof any 完全等价吗</summary>
...
<details><summary>#### 模块扩充和声明合并的区别</summary>

模块扩充是在外部文件中向其他模块添加导出。声明合并是同一个模块中多次声明同名接口自动合并。模块扩充只能添加新成员，不能修改已有成员的类型。

</details>
<details><summary>#### 模块扩充必须在模块文件中吗</summary>
...
<details><summary>#### declare global 和直接在 .d.ts 中声明全局类型有什么区别</summary>
...
<details><summary>#### 现代项目还需要用 namespace 吗</summary>
...
<details><summary>#### strict 包含哪些选项</summary>
...
<details><summary>#### 应该用什么 moduleResolution</summary>
...
<details><summary>#### 开启 strict 后报错太多怎么办</summary>

可以先设 strict: true，然后单独关闭某些子选项。比如 `"strict": true, "strictPropertyInitialization": false`。逐步修复后再逐个重新开启。

</details>
<details><summary>#### strict 会随 TypeScript 版本增加新的子选项吗</summary>
...
<details><summary>#### 哪些情况下会触发隐式 any 报错</summary>
...
<details><summary>#### 开启后如何处理大量的空检查报错</summary>
...
<details><summary>#### 为什么方法简写不受影响</summary>
...
<details><summary>#### noImplicitReturns 是 strict 的一部分吗</summary>
...
<details><summary>#### 类方法需要声明 this 参数吗</summary>
...
<details><summary>#### 配置 typeRoots 后 @types 下的包不生效了</summary>
...
<details><summary>#### target 和 lib 有什么区别</summary>

target 决定编译输出的语法版本（箭头函数是否降级等）。lib 决定可用的类型定义（Promise、Map 等 API 类型是否可用）。两者独立配置。

</details>
<details><summary>#### 现代项目 target 应该设成什么</summary>
...
<details><summary>#### module 和 moduleResolution 的关系</summary>
...
<details><summary>#### 前端项目应该设什么</summary>
...
<details><summary>#### esModuleInterop 和 allowSyntheticDefaultImports 的区别</summary>

`allowSyntheticDefaultImports` 只影响类型检查（允许编译器不报错），不生成辅助代码。`esModuleInterop` 同时影响类型检查和编译输出（生成辅助代码确保运行时正确）。推荐直接用 esModuleInterop。

</details>
<details><summary>#### 使用 Vite/webpack 时还需要开启吗</summary>
...
<details><summary>#### skipLibCheck 会降低项目的类型安全吗</summary>

对项目自己的 .ts 代码不会。skipLibCheck 只跳过 .d.ts 文件，项目代码仍然被严格检查。但项目中自定义的 .d.ts 声明文件的错误也不会被发现。

</details>
<details><summary>#### 什么时候不应该开启 skipLibCheck</summary>
...
<details><summary>#### 什么情况下闭包中的收窄仍然不生效</summary>

如果变量在类型守卫之后、闭包创建之前被重新赋值，收窄不会在闭包中保留。这是合理的——重新赋值可能改变了变量的类型。

</details>
<details><summary>#### 如何确保闭包中的收窄生效</summary>
...
<details><summary>#### NoInfer 之前怎么实现类似效果</summary>

在 5.4 之前需要用一些技巧，比如 `T & {}` 或拆分为两个泛型参数配合约束。NoInfer 提供了更清晰、更直接的方式。

</details>
<details><summary>#### NoInfer 会影响运行时吗</summary>
